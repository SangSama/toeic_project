...
export default class DetailsGrammarUser extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllDetailsGrammarUsers();
  }
  ...
  public retrieveAllDetailsGrammarUsers(): void {
  ...
  public prepareRemove(instance: IDetailsGrammarUser): void {
  ...
  public removeDetailsGrammarUser(): void {
    this.detailsGrammarUserService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('finalProjectApp.detailsGrammarUser.deleted', { param: this.removeId });
