...
export default class GrammarAnswer extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllGrammarAnswers();
  }
  ...
  public retrieveAllGrammarAnswers(): void {
  ...
  public prepareRemove(instance: IGrammarAnswer): void {
  ...
  public removeGrammarAnswer(): void {
    this.grammarAnswerService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('finalProjectApp.grammarAnswer.deleted', { param: this.removeId });
