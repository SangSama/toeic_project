...
export default class VocabularyTopic extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllVocabularyTopics();
  }
  ...
  public retrieveAllVocabularyTopics(): void {
  ...
  public prepareRemove(instance: IVocabularyTopic): void {
  ...
  public removeVocabularyTopic(): void {
    this.vocabularyTopicService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('finalProjectApp.vocabularyTopic.deleted', { param: this.removeId });
