...
export default class Vocabulary extends Vue {
  ...
  public retrieveAllVocabularys(): void {
  ...
  public prepareRemove(instance: IVocabulary): void {
  ...
  public removeVocabulary(): void {
    this.vocabularyService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('finalProjectApp.vocabulary.deleted', { param: this.removeId });
