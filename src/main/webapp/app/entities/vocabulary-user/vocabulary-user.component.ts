...
export default class VocabularyUser extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllVocabularyUsers();
  }
  ...
  public retrieveAllVocabularyUsers(): void {
  ...
  public prepareRemove(instance: IVocabularyUser): void {
  ...
  public removeVocabularyUser(): void {
    this.vocabularyUserService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('finalProjectApp.vocabularyUser.deleted', { param: this.removeId });
