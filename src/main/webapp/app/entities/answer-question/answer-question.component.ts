...
export default class AnswerQuestion extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllAnswerQuestions();
  }
  ...
  public retrieveAllAnswerQuestions(): void {
  ...
  public prepareRemove(instance: IAnswerQuestion): void {
  ...
  public removeAnswerQuestion(): void {
    this.answerQuestionService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('finalProjectApp.answerQuestion.deleted', { param: this.removeId });
