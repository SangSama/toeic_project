...
export default class DetailsVocabularyUser extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllDetailsVocabularyUsers();
  }
  ...
  public retrieveAllDetailsVocabularyUsers(): void {
  ...
  public prepareRemove(instance: IDetailsVocabularyUser): void {
  ...
  public removeDetailsVocabularyUser(): void {
    this.detailsVocabularyUserService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('finalProjectApp.detailsVocabularyUser.deleted', { param: this.removeId });
