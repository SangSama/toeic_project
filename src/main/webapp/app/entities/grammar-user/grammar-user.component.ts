...
export default class GrammarUser extends Vue {
  ...
  public retrieveAllGrammarUsers(): void {
  ...
  public prepareRemove(instance: IGrammarUser): void {
  ...
  public removeGrammarUser(): void {
    this.grammarUserService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('finalProjectApp.grammarUser.deleted', { param: this.removeId });
