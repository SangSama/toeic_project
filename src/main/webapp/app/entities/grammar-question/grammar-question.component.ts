...
export default class GrammarQuestion extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllGrammarQuestions();
  }
  ...
  public retrieveAllGrammarQuestions(): void {
  ...
  public prepareRemove(instance: IGrammarQuestion): void {
  ...
  public removeGrammarQuestion(): void {
    this.grammarQuestionService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('finalProjectApp.grammarQuestion.deleted', { param: this.removeId });
